...
public:
    ...
    virtual QString askForChoice(const QString &skill_name, const QString &choices , const QVariant &data = QVariant()) = 0;
...
public:
    ...
    virtual QString askForChoice(const QString &skill_name, const QString &choices, const QVariant &data = QVariant());
