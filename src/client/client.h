...
public:
    ...
    void askForSkillLearn(const Json::Value &tab_index);
	...
	void askForGeneralPass(const Json::Value &);
...
public slots:
    ...
    void onPlayerChooseGeneralPass(const QString &_name);
    void onPlayerMakeChoice();    
    void onPlayerMakeSkillChoice();
...
signals:
    ...
    void pass_generals_got(const QString &flags);
    ...
    void skills_got(const QString &tab_index);
