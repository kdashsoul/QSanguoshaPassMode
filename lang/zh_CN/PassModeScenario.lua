local pass_t = {
    ...
    ["shiqi_p"]                  	= "士气",
    [":shiqi_p"]                 	= "摸牌阶段开始时，你可以进行一次判定，若为红色则你获得此牌。",
    ["qianggong_p"]              	= "强弓",
    [":qianggong_p"]             	= "当你使用【杀】指定一名角色为目标后，以下两种情况，你可以令此【杀】不可被【闪】响应：1、你的体力值小于或等于1。2、你的攻击范围大于3。",
    ["pojia_p"]                  	= "破甲",
    [":pojia_p"]                 	= "锁定技，你使用的黑色【杀】无视目标防具；红色【杀】命中时，随机弃置目标一张装备牌。",
    ["zhanshang_p"]              	= "战觞",
    [":zhanshang_p"]             	= "当你成为【南蛮入侵】或【万箭齐发】的目标时，你可以摸一张牌。",
    ["qishu_p"]                  	= "骑术",
    ...
    ["yaoshu_p"]                    = "妖术",
    [":yaoshu_p"]                   = "出牌阶段，你可以弃置一张黑桃手牌，令一名角色进行判定，若结果为黑色，你对该角色造成1点雷电伤害。每阶段限一次。",
    ["jitian_p"]                    = "祭天",
    [":jitian_p"]                   = "锁定技，当你受到一次雷电伤害前，摸X张牌（X为伤害点数），然后伤害为0。",
    ["lianzhan_p"]               	= "连斩",
    [":lianzhan_p"]              	= "当你使用的【杀】被目标角色的【闪】抵消时，你可以再对其使用一张【杀】，若此【杀】命中则伤害+1。",
    ["douzhi_p"]                 	= "斗志",
    [":douzhi_p"]                	= "摸牌阶段开始时，若你没有手牌，可以额外摸X张牌（X为你的体力值），回合结束时，你可以将手牌补至体力上限。",
    ...
    [":jianxiong_p"]             	= "当你受到一次伤害后，可以获得X枚“奸雄标记”（X为伤害点数），然后选择获得对你造成伤害的牌或者摸一张牌。",
    ["@jianxiong_p"]                = "奸雄",
    ["jianxiong-p:gain"]			= "获得造成伤害的牌",
    ["jianxiong-p:draw"]  			= "摸1张牌",
    ["xietian_p"]                	= "挟天",
    ...
    ["guimou_p"]                 	= "鬼谋",
    [":guimou_p"]               	= "在一名角色的判定牌生效后，若此牌为红色且点数大于你体力值与手牌数之和，你可以摸一张牌。",
    ...
    ["guantong-p:damage"]	  	  	= "弃1张牌伤害下家",
    ["guantong-p:draw"]				= "摸1张牌",
