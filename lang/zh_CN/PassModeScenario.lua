local pass_t = {
	...
	[":rende_e1"]                   = "触发恢复体力效果所需牌数 -1。" ,
	[":rende_e2"]                   = "允许使用装备牌发动。" ,
	[":rende_e3"]                   = "可以选择将牌给其他角色或弃置。" ,
	[":jijiang_e1"]                 = "由系统提供一张无属性的杀，每关限用3次。" ,

	["kuanhou_p"]                 	= "宽厚" ,
	[":kuanhou_p"]                 	= "回合结束时，若你没有手牌，可以摸牌直到摸到基本牌为止。" ,
	["wanghou_p"]                 	= "王侯" ,
	[":wanghou_p"]                 	= "红色的9和5可以当任意基本牌和非延时锦囊使用或打出。" ,
	["xiaoxiong_p"]                 = "枭雄" ,
	[":xiaoxiong_p"]                = "每当你失去装备牌时，回复1点体力。" ,
	["qiangyun_p"]                 	= "强运" ,
	[":qiangyun_p"]                 = "可进行两次判定。" ,
