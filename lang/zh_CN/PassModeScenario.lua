local pass_t = {
	...
	[":weimu_p"]    				= "当黑色锦囊即将对你生效时，你可以弃置一张与此牌颜色相同的手牌使其无效，然后摸一张牌。",
	["@@weimu_p"]					= "请弃置一张符合条件的手牌",
	["dumou_p"]     				= "毒谋",
	["@dumou_p"]     				= "毒谋",
	[":dumou_p"]    				= "当你使用的非延时单体锦囊指定一名角色为目标后，你可以选择一种花色然后展示目标一张手牌，若所选花色与此牌花色相同，你对目标角色造成1点伤害并获得1枚“毒谋标记”。",
	[":wansha_p"]    				= "当除你以外的角色濒死时，可以弃置1枚“毒谋标记”使只有该角色才能使用【桃】。",
	[":luanwu_p"] 					= "出牌阶段，可弃置2枚“毒谋标记”令所有其他角色各选择一项：对与其距离最近的另一名角色使用一张【杀】，或失去1点体力。", 
