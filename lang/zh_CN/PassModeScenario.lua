local pass_t = {
	...
	[":jianxiong_e1"]               = "可以选择获得造成伤害的牌或摸1张牌。",
	[":jianxiong_e2"]               = "发动时若体力为1可以额外摸2张牌。",
	...
	["qiangyun_p"]                 	= "强运" ,
	[":qiangyun_p"]                 = "你的判定牌亮出后（改判之前），可以从牌堆顶重新亮出一张作为即将生效的判定牌，每阶段限1次。" ,
        ["badao_p"]                    	= "霸气",
        [":badao_p"]                   	= "其他角色于出牌阶段对你造成2点或以上伤害时，须立即进入弃牌阶段。",
	["caiqing_p"]                   = "才情",
	[":caiqing_p"]                  = "你于弃牌阶段弃置牌的数量不小于2张时，可以回复1点体力。",
	["duoyi_p"]                    	= "多疑",
	[":duoyi_p"]                   	= "出牌阶段，当你使用的【杀】被【闪】抵消时，可以额外使用1张【杀】，每阶段限1次。",
	["honglang_p"]                  = "弘朗",
	[":honglang_p"]                 = "每当你摸牌后，若手牌数为2张，可以再摸1张牌。",
	["shanshe_p"]                   = "善射",
