local pass_t = {
	...
	["guoshi_p"]		=	"国士",
	[":guoshi_p"]		=	"摸牌阶段，你可以放弃摸牌，改为从堆顶亮出X张牌，你可以获得不同种类的牌各1张，其余牌弃置（X为你的手牌数且最大为5）。",
	["dudu_p"]		=	"都督",
	[":dudu_p"]		=	"当你受到一次伤害时，可以弃置一张装备区的牌使伤害 -1。",
	["zhejie_p"]		=	"折节",
	[":zhejie_p"]		=	"出牌阶段，你可以指定一名手牌数比你少的角色，弃置一张手牌，然后你交给其一张手牌，每阶段限一次。",
	["danmou_p"]		=	"胆谋",
	[":danmou_p"]		=	"回合开始阶段，你可以摸两张牌，若如此做，回合结束阶段，你须弃置三张牌或失去1点体力。",
	["yuyue_p"]		=	"雨月",
	[":yuyue_p"]		=	"出牌阶段，你可以弃置一张牌指定一名判定区有牌的其他角色，视为你对其使用X张【杀】（X为其判定区牌的数量）。每阶段限一次。",
